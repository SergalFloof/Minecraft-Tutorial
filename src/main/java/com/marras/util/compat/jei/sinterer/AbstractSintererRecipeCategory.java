...
public abstract class AbstractSintererRecipeCategory<T extends IRecipeWrapper> implements IRecipeCategory<T>{
	...
	public AbstractSintererRecipeCategory(IGuiHelper helper) {
