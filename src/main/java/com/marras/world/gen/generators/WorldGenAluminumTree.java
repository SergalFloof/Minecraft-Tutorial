package com.marras.world.gen.generators;
...
public class WorldGenAluminumTree extends WorldGenAbstractTree {
	...
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.ALUMINUM);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeave.VARIANT, EnumHandler.EnumType.ALUMINUM);
