...
public class BlockLeave extends BlockLeaves implements IMetaName, IHasModel{
	...
	public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
		return NonNullList.withSize(1, new ItemStack(this, world.getBlockState(pos).getValue(VARIANT).getMeta()));
	}
