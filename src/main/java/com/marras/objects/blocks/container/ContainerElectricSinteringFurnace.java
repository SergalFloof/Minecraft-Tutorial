...
{
	private final TEElectricSinteringFurnace tileentity;
	private int cookTime, energy;
	
	public ContainerElectricSinteringFurnace(InventoryPlayer player, TEElectricSinteringFurnace tileentity) 
	{
