package com.marras.objects.blocks.tileentity;
...
public class TESinteringFurnace extends TileEntity implements ITickable
{
	...
	public static boolean isBurning(TESinteringFurnace te) 
	{
